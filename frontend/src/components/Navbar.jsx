    ...
    <nav className="block w-full bg-white shadow-md mb-2">
      <div className="container mx-auto flex items-center justify-between px-4 py-2 lg:px-8 lg:py-3">
       ...
       <ul class="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
         <li onClick={() => scrollToSection(featuresRef)} class="flex items-center p-1 text-sm gap-x-2 text-slate-600">
         ...
         <li onClick={() => scrollToSection(contributorsRef)} class="flex items-center p-1 text-sm gap-x-2 text-slate-600">
           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6 text-slate-500">
       ...
       <Link to = '/signup'>
        ...
        <div className="items-center hidden gap-x-2 lg:flex">
          ...
          <button className="rounded-md bg-slate-800 py-2 px-4 text-sm text-white transition-all shadow-md hover:shadow-lg focus:bg-slate-700">
            Search
          </button>
        </div>
        ...
        <div className="lg:hidden">
          <div className="px-4 py-2 space-y-3">
            <ul className="flex flex-col gap-2">
              <li onClick={() => handleMobileClick(featuresRef)} className="flex items-center p-2 text-sm gap-x-2 text-slate-600 hover:bg-slate-50 rounded-md cursor-pointer">
              ...
              <li onClick={() => handleMobileClick(contributorsRef)} className="flex items-center p-2 text-sm gap-x-2 text-slate-600 hover:bg-slate-50 rounded-md cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="h-6 w-6 text-slate-500">
              ...
              <li onClick={() => handleMobileClick(footerRef)} className="flex items-center p-2 text-sm gap-x-2 text-slate-600 hover:bg-slate-50 rounded-md cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="h-6 w-6 text-slate-500">
              ...
              <Link to = '/signup'>
              <li className="flex items-center p-2 text-sm gap-x-2 text-slate-600 hover:bg-slate-50 rounded-md cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="h-6 w-6 text-slate-500">
            ...
            <div className="space-y-2">
              ...
              <button className="w-full rounded-md bg-slate-800 py-2 px-4 text-sm text-white transition-all shadow-md hover:shadow-lg focus:bg-slate-700">
                Search
              </button>
            </div>
          </div>
